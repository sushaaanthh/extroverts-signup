...
function validateAge(age: string): string | undefined {
  ...
  if (isNaN(n) || n < 1 || n > MAX_AGE) return "Please enter a valid age."
  if (n < MIN_AGE) return "You must be 18 or older to continue."
  return undefined
}
        ...
        <div className="step-enter flex flex-col flex-1 px-5 pt-12 pb-8">
          ...
          <div className="mt-10 mb-8">
            ...
            <p className="text-white/35 text-sm mt-2.5">
              Your profile helps us find your people.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <TextInput
              ...
              onChange={(val) =>
                wizard.updateForm({ age: val.replace(/\D/g, "").slice(0, 3) })
              }
