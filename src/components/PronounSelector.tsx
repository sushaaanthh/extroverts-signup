...
export function PronounSelector({ value, onChange, error }: PronounSelectorProps) {
  return (
    <div className="flex flex-col gap-2">
      <div className="flex flex-wrap gap-2" role="group" aria-label="Select your pronouns">
        {PRONOUNS.map((p) => (
          <button
            key={p}
            type="button"
