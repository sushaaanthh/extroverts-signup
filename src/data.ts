...
export const locationData: LocationData = {
  ...
  Delhi: {
    ...
    colleges: {
      ...
      "East Delhi": ["Delhi College of Engineering (East)", "Other"],
    },
  },
  "Tamil Nadu": {
    ...
    colleges: {
      ...
      Salem: ["Periyar University", "SSM College of Engineering", "Other"],
      Trichy: [
        "NIT Tiruchirappalli",
  ...
  "Andhra Pradesh": {
    ...
    colleges: {
      ...
      Vijayawada: ["SRM University AP", "K L University", "Other"],
      Guntur: [
        "Acharya Nagarjuna University",
        "Bapatla Engineering College",
        "Other",
      ],
      Tirupati: ["Sri Venkateswara University", "IIIT Sri City", "Other"],
    },
  },
  "West Bengal": {
    ...
    colleges: {
      ...
      Howrah: ["IIEST Shibpur", "Other"],
      Siliguri: ["North Bengal University", "Other"],
      Durgapur: ["NIT Durgapur", "BIT Mesra (nearby)", "Other"],
    },
  },
  Rajasthan: {
    ...
    colleges: {
      ...
      Jodhpur: ["IIT Jodhpur", "Jai Narain Vyas University", "Other"],
      Udaipur: ["Mohanlal Sukhadia University", "Pacific University", "Other"],
      Kota: [
